    ...
    <div class=" h-full ">
       <div class=" flex lg:flex-row h-full">
         ...
         <div class="w-1/2 lg:w-1/4 flex flex-col">
          ...
          <a href="https://docs.deploy.art" target="_blank" class="no-underline text-sm text-gray-200 hover:text-purple-500 ">Deploy.Art Docs</a>
           <a href="https://etherscan.io/address/0x4e3c5d37ca4d92b54248c411b496a0c959bcfe57" target="_blank" class="no-underline text-sm text-gray-200 hover:text-purple-500">Smart Contract</a>
